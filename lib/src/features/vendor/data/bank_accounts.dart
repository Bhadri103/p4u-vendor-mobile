...
Map<String, dynamic> bankAccountFromForm(
  ...
  final ifsc =
      _str(values['ifsc_code'] ?? values['bank_ifsc'] ?? values['ifscCode'])
          .toUpperCase();
  ...
  return {
    'id': id,
    'bankName': _str(values['bank_name'] ?? values['bankName']).trim(),
...
Map<String, dynamic> _normalizeAccountRow(Map<String, dynamic> a) {
  ...
  return {
    ...
    'accountHolderName': _str(a['accountHolderName'] ??
        ...
        a['account_holder']),
    'accountNumber': _str(a['accountNumber'] ?? a['account_number']),
    'ifscCode':
