            ...
            child: ListView(
              ...
              children: [
                const VendorPageIntro(
                  ...
                  subtitle:
                      'Track customer appointments from confirmation to completion.',
                ...
                if (items.isEmpty)
                  ...
                  if (completed.isNotEmpty)
                    _Section('Completed / Cancelled / Rejected', completed),
                ],
              ],
            ),
          );
...
class _Section extends ConsumerWidget {
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      if (status == 'completion_pending')
                        FilledButton(
                            onPressed: () =>
                                _verifyCompletionOtp(context, ref, b),
  ...
  Future<void> _complete(
    ...
    await _verifyCompletionOtp(context, ref, booking);
  }
